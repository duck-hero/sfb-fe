...
export default function ImportCustomerModal({
    ...
    const handleDownloadTemplate = async () => {
        try {
            ...
            link.href = '/templates/customer-template.xlsx'; // Assuming a similar path
    ...
    const handleImport = async () => {
        ...
        try {
            ...
            // Call import API
            await customerApi.importCustomers(formData);

            toast.success("Import khách hàng thành công!");
            onSuccess?.();
            onClose();
                            ...
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left shadow-xl transition-all">
                                ...
                                <div className="mt-6 flex justify-end gap-3">
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-lg font-semibold transition flex items-center ${uploading
