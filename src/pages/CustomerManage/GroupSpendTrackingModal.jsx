...
import { X, ChevronLeft, ChevronRight, RotateCw, ChevronDown, Eye, BarChart3, Plus, Save, Trash2 } from "lucide-react";
...
const GroupSpendTrackingModal = ({ open, group, onClose }) => {
  ...
  const handleAddManualPayment = async (e) => {
    ...
    try {
      const payload = {
        customerGroupId: groupId, // Pass customerGroupId instead of customerId
