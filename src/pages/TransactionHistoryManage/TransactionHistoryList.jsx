...
const TransactionHistoryList = () => {
  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      const blob = await transactionHistoryApi.exportExcel(
        filters.sortOrder,
        filters.fromEffectiveDate,
        filters.toEffectiveDate,
        filters.searchTerm || undefined,
  ...
  const handleFacebookReconciliation = () => {
    ...
    const url = `https://875ccbb5.automationacb.pages.dev/check-bill-fb?token=999999999&fromDate=${fromDate}&toDate=${toDate}`;
